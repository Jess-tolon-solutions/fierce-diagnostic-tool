  ...
  return (
    <div className="stage-enter max-w-2xl mx-auto pt-8 pb-12">
      ...
      <h2 className="text-3xl md:text-4xl font-black tracking-tight leading-[1.1] fierce-underline pb-3">
        A few details for your account manager.
      </h2>

      <p className="text-fierce-cream/60 text-base md:text-lg mt-6 leading-relaxed">
        We&apos;ve got what we need to recommend the right module. These few
        details help your account manager come to the call ready to plan.
      </p>

      <div className="mt-10 space-y-8">
        {/* In-person reinforcement — replaces the old format-choice chips */}
        <div className="rounded-2xl border border-fierce-orange/25 bg-gradient-to-br from-fierce-orange/[0.06] to-fierce-orange-deep/[0.03] p-5 md:p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-fierce-cream/70 mt-1.5 leading-relaxed">
                Your master facilitator runs the 45-minute session on-site, in
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {[
              ...
              <button
                key={w}
                onClick={() => setWindow(w)}
                className={`chip text-sm py-2.5 px-3 rounded-lg ${
                  window === w ? "selected" : ""
                }`}
              >
                {w}
        ...
        <div>
          <p className="text-xs font-bold tracking-widest text-fierce-cream/50 uppercase mb-3">
            Anything else your account manager should know?{" "}
